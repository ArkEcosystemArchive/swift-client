...
extension Two {
    class Wallets {
        ...
        public func top(limit: Int = 20, page: Int = 1, completionHandler: @escaping (Dictionary<String, Any>?) -> Void) {
            apiGetHandler("\(endpoint)/top", ["limit": limit, "page": page], completionHandler)
        }
        
        /// Retrieves all transactions of a given wallet
        public func transactions(byName id: String, limit: Int = 20, page : Int = 1, completionHandler: @escaping (Dictionary<String, Any>?) -> Void) {
            apiGetHandler("\(endpoint)/\(id)/transactions", ["limit": limit, "page": page], completionHandler)
        }
        
        public func transactions(byAddress id: String, limit: Int = 20, page : Int = 1, completionHandler: @escaping (Dictionary<String, Any>?) -> Void) {
            apiGetHandler("\(endpoint)/\(id)/transactions", ["limit": limit, "page": page], completionHandler)
        }
        
        public func transactions(byKey id: String, limit: Int = 20, page : Int = 1, completionHandler: @escaping (Dictionary<String, Any>?) -> Void) {
            apiGetHandler("\(endpoint)/\(id)/transactions", ["limit": limit, "page": page], completionHandler)
        }
        
        /// Retrieves all sent transactions of a given wallet
        public func sentTransactions(byName id: String, limit: Int = 20, page : Int = 1, completionHandler: @escaping (Dictionary<String, Any>?) -> Void) {
            apiGetHandler("\(endpoint)/\(id)/transactions/sent", ["limit": limit, "page": page], completionHandler)
        }
        
        public func sentTransactions(byAddress id: String, limit: Int = 20, page : Int = 1, completionHandler: @escaping (Dictionary<String, Any>?) -> Void) {
            apiGetHandler("\(endpoint)/\(id)/transactions/sent", ["limit": limit, "page": page], completionHandler)
        }
        
        public func sentTransactions(byKey id: String, limit: Int = 20, page : Int = 1, completionHandler: @escaping (Dictionary<String, Any>?) -> Void) {
            apiGetHandler("\(endpoint)/\(id)/transactions/sent", ["limit": limit, "page": page], completionHandler)
        }
        
        /// Retrieves all received transactions of a given wallet
        public func receivedTransactions(byName id: String, limit: Int = 20, page : Int = 1, completionHandler: @escaping (Dictionary<String, Any>?) -> Void) {
            apiGetHandler("\(endpoint)/\(id)/transactions/received", ["limit": limit, "page": page], completionHandler)
        }
        
        public func receivedTransactions(byAddress id: String, limit: Int = 20, page : Int = 1, completionHandler: @escaping (Dictionary<String, Any>?) -> Void) {
            apiGetHandler("\(endpoint)/\(id)/transactions/received", ["limit": limit, "page": page], completionHandler)
        }
        
        public func receivedTransactions(byKey id: String, limit: Int = 20, page : Int = 1, completionHandler: @escaping (Dictionary<String, Any>?) -> Void) {
            apiGetHandler("\(endpoint)/\(id)/transactions/received", ["limit": limit, "page": page], completionHandler)
        }
        
        /// Retrieves all votes of a wallet
        public func votes(byName id: String, limit: Int = 20, page : Int = 1, completionHandler: @escaping (Dictionary<String, Any>?) -> Void) {
            apiGetHandler("\(endpoint)/\(id)/votes", ["limit": limit, "page": page], completionHandler)
        }
        
        public func votes(byAddress id: String, limit: Int = 20, page : Int = 1, completionHandler: @escaping (Dictionary<String, Any>?) -> Void) {
            apiGetHandler("\(endpoint)/\(id)/votes", ["limit": limit, "page": page], completionHandler)
        }
